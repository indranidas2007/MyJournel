...
<body>
<?php
//echo "Welcome " . $_SESSION["adminlog"] . ".<br>";
?>
<div class="wrapper">
    <div class="sidebar">
        <h2>My Journel</h2>
        <div class="site-content-section-inner">
          <div class="section-heading"></div>	
						<div class="admin-sub-heading">Welcome Admin, <?php echo $_SESSION["adminlog"] . ".<br>"; ?></div>
					</div>	
        <ul>
            <li><a href="dashboard.php"><i class="fas fa-home"></i>Home</a></li>
            <li><a href="#"><i class="fas fa-user"></i>Compose</a></li>
            <li><a href="#"><i class="fas fa-address-card"></i>Starred</a></li>
            <li><a href="#"><i class="fas fa-project-diagram"></i>Share</a></li>
